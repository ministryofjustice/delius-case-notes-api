package uk.gov.jusice.digital.noms.delius;
...
import spark.Spark;
import uk.gov.jusice.digital.noms.delius.config.Configuration;
import uk.gov.jusice.digital.noms.delius.config.ObjectMapperFactory;
...
import uk.gov.jusice.digital.noms.delius.service.Service;
...
public class DeliusCaseNotesAPI {
    ...
    public static void run(Configuration configuration) {
        ...
        post("/casenote/:nomisId/:noteId", (req, res) ->
                {
                    ...
                    return created.isPresent() ? created.get() : null;
                }
        );
